...
Namespace Binding
    Public Class BoundGlobalScope
        ...
        Public Sub New(syntax As SyntaxNode, previous As BoundGlobalScope, diagnostics As ErrorList, variables As IEnumerable(Of VariableSymbol), statements As IEnumerable(Of BoundStatement))
            Me.Syntax = syntax
